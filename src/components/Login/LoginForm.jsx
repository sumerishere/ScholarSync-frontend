      ...
      <div className="login-illustration w-1/2 bg-indigo-700 flex items-center justify-center p-12">
        <div className="illustration-content text-center">
          ...
          <p className="text-white mt-4">
            ...
            highlighting collaboration. "Empowering Education, Connecting Minds"`}
          </p>
        </div>
      </div>
        ...
        <div className="login-form-wrapper w-full max-w-md">
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-600">
              Welcome to your educational management platform
            </p>
          </div>

          <h2 className="text-2xl font-bold-md text-gray-800 mb-6">
            Hi, Welcome! Back
          </h2>
          <p className="text-gray-600 mb-8">
            Please enter your credentials to access ScholarSync
          </p>
